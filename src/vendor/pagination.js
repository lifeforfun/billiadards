!function ($) {
    ...
    Pagination.prototype = {
        ...
        _drawInner: function () {
            ...
            var tpl = '<li class="prev' + (this.currentPage - 1 <= 0 ? ' disabled' : ' ') + '"><a href="#" data="' + (this.currentPage - 1) + '">«上一页</a></li>';
        ...
        //值传递
        _drawCtrl: function () {
            var tpl = '<li class="disabled"><a>共'+this.itemsCount+'条</a></li>';
            return tpl;
        },
    ...
    $.fn.pagination = function (options) {
        var args,
            opts = $.extend({}, $.fn.pagination.defaults, typeof options == 'object' && options);
